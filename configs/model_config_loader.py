...
def flatten_model_config_v2(raw: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if isinstance(out.get("model_structure"), dict):
        ...
        if isinstance(mroot, dict):
            ...
            for k in (
                ...
                "stage3_use_coa_action_loss",
                "stage3_action_latent_loss_weight",
                "stage3_action_latent_detach_target",
                ...
                "stage4_full_coa_ar",
                "stage4_replace_video_diffusion",
                "stage4_replace_action_diffusion",
                "stage4_video_ar_causal_attention",
                "stage4_action_ar_causal_attention",
                "stage4_keyframe_loss_weight",
                "stage4_video_ar_loss_weight",
                "stage4_key_action_loss_weight",
                "stage4_action_ar_loss_weight",
                "stage4_action_latent_loss_weight",
                "stage4_action_latent_detach_target",
                "goal_conditioned_wam",
                "predict_key_video",
                "predict_key_action",
                "key_action_chunk_size",
                "use_predicted_key_condition",
                "detach_predicted_key_condition",
                "reverse_video_key_condition_type",
                "reverse_action_key_condition_type",
                "key_video_loss_weight",
                "key_action_loss_weight",
                "reverse_video_loss_weight",
                "reverse_action_loss_weight",
                "reverse_world_order",
                "goal_conditioned_multistep_inference",
                "goal_conditioned_return_forward_actions",
                "goal_conditioned_video_guidance_scale",
                "goal_joint_key_diffusion",
                "goal_joint_reverse_diffusion",
            ):
    ...
    for k_flat, k_nested in (
        ...
        ("stage3_use_coa_action_loss", "stage3_use_coa_action_loss"),
        ("stage3_action_latent_loss_weight", "stage3_action_latent_loss_weight"),
        ("stage3_action_latent_detach_target", "stage3_action_latent_detach_target"),
        ...
        ("stage4_full_coa_ar", "stage4_full_coa_ar"),
        ("stage4_replace_video_diffusion", "stage4_replace_video_diffusion"),
        ("stage4_replace_action_diffusion", "stage4_replace_action_diffusion"),
        ("stage4_video_ar_causal_attention", "stage4_video_ar_causal_attention"),
        ("stage4_action_ar_causal_attention", "stage4_action_ar_causal_attention"),
        ("stage4_keyframe_loss_weight", "stage4_keyframe_loss_weight"),
        ("stage4_video_ar_loss_weight", "stage4_video_ar_loss_weight"),
        ("stage4_key_action_loss_weight", "stage4_key_action_loss_weight"),
        ("stage4_action_ar_loss_weight", "stage4_action_ar_loss_weight"),
        ("stage4_action_latent_loss_weight", "stage4_action_latent_loss_weight"),
        ("stage4_action_latent_detach_target", "stage4_action_latent_detach_target"),
        ("goal_conditioned_wam", "goal_conditioned_wam"),
        ("predict_key_video", "predict_key_video"),
        ("predict_key_action", "predict_key_action"),
        ("key_action_chunk_size", "key_action_chunk_size"),
        ("use_predicted_key_condition", "use_predicted_key_condition"),
        ("detach_predicted_key_condition", "detach_predicted_key_condition"),
        ("reverse_video_key_condition_type", "reverse_video_key_condition_type"),
        ("reverse_action_key_condition_type", "reverse_action_key_condition_type"),
        ("key_video_loss_weight", "key_video_loss_weight"),
        ("key_action_loss_weight", "key_action_loss_weight"),
        ("reverse_video_loss_weight", "reverse_video_loss_weight"),
        ("reverse_action_loss_weight", "reverse_action_loss_weight"),
        ("goal_conditioned_multistep_inference", "goal_conditioned_multistep_inference"),
        ("goal_conditioned_return_forward_actions", "goal_conditioned_return_forward_actions"),
        ("goal_conditioned_video_guidance_scale", "goal_conditioned_video_guidance_scale"),
        ("goal_joint_key_diffusion", "goal_joint_key_diffusion"),
        ("goal_joint_reverse_diffusion", "goal_joint_reverse_diffusion"),
